...
export const REDLINES = [
  {
    ...
    keywords: ['转账', '汇款', '打钱', '入金', '出金', '定金', '押金', '保证金', '手续费', '解冻金', '安全账户', '扫码转', '会费', '刷单', '垫付', '返利', '充值', '点卡', '礼品卡', '打款', '缴费'],
  ...
  },
  {
    ...
    keywords: ['缅甸', '缅北', '果敢', '佤邦', '金三角', '柬埔寨', '妙瓦底', '偷渡', '卖猪仔', '车手', '境外高薪', '包吃包住高薪'],
  ...
  investor: {
    beats: [
      ...
      { type:'hinge', id:'h3', resolve:true,
        ...
        choices:[
          { label:'说"第一笔我帮你垫，亏了算我的"', technique:'互惠小惠', quality:'good',
            line:'这样，第一笔我用我的钱帮你垫，赚了算你的、亏了算我的，你还怕啥？' },
          { label:'说"张姐李哥都跟着我做"', technique:'社会认同', quality:'good',
            line:'我们群里张姐李哥都跟着做，上个月都翻倍了，你可以问他们。' },
          { label:'说"爱信不信"', technique:'制造紧迫', quality:'jump',
            line:'信不信随你，好机会不等人，今晚就截止！' },
        ] },
